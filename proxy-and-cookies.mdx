...
| Method | How |
|--------|-----|
| **GET** requests | `proxy` as a **query parameter** |
| **POST/DELETE/PATCH** requests | `"proxy"` in the **JSON body** |
...
| Method | How |
|--------|-----|
| **GET** requests | `cookie` as a **query parameter** |
| **POST/DELETE/PATCH** requests | `"cookie"` in the **JSON body** |
